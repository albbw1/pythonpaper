...
pretrained_model = {'resnet50' : './models/pretrained/weights_198_492_0.9526_0.9827.pth',}
...
class LoadConfig(object):
    def __init__(self, args, version):
        ...
        if args.dataset == 'product':
            ...
            self.numcls = 100
        elif args.dataset == 'dadou':
            self.dataset = args.dataset
            self.rawdata_root = './datasets/dadou/data'
            self.anno_root = './datasets/dadou/anno'
            self.numcls = 200
        elif args.dataset == 'leaf220':
            self.dataset = args.dataset
            self.rawdata_root = './datasets/leaf220/data'
            self.anno_root = './datasets/leaf220/anno'
            self.numcls = 220
